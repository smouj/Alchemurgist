...
Specialized skill for **transformation** operations in multi-agent environments (OpenClaw/KiloCode).

## Overview

Alchemurgist helps execute transformation tasks with a secure, repeatable, and audit-friendly workflow.

## When to use

- You need structured execution in the **transformation** domain.
- You want reproducible outputs (plan, verification, rollback).
- You need explicit safety guardrails and operator control.

## Core capabilities

- Trigger-based activation for transformation scenarios.
...
**Input:** "Audit and improve transformation workflow."
