# 🧪 Alchemurgist — Agent Runtime Architecture
...
flowchart LR
  ...
  B --> C[Structure rebuild]
  C --> D[Execution]
  D --> E[Verification]
  E --> F[Outcome report]
```

**Canonical flow:** Format detect -> OCR/parse -> Structure rebuild -> Schema validate -> Export

## Core components
Legacy doc normalization, OCR/layout parsing, structured markdown/JSON conversion pipeline.
