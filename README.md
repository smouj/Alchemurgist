...
**Alchemurgist** es una skill especializada en **transformation** para ecosistemas multiagente (OpenClaw/KiloCode), diseñada para ejecutar tareas con seguridad, trazabilidad y resultados reproducibles.

## Cuándo usarla

- Cuando la tarea pertenece al dominio de **transformation**.
...
**Input:** “Necesito revisar y endurecer el flujo de transformation”.
